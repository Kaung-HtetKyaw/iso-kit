...
export type AuthenticateMutation = {
    authenticate: { token: string; user: { id: string; username: string; displayName: string } };
};
...
export type TopicFullDataFragment = {
    ...
    title: string;
    body: string;
    messages: Array<{ id?: string | null; body: string; author: { id: string; displayName: string } }>;
    author: { id: string; displayName: string };
};
...
export type OnTopicUpdatesSubscription = { topicUpdated: { id?: string | null } };

export type UserPreviewDataFragment = { id: string; displayName: string };

export type UserFullDataFragment = { id: string; username: string; displayName: string };
...
export type CreateNewAccountMutation = { createAccount: { id: string } };

export type UpdateDisplayNameMutationVariables = Exact<{
    displayName: Scalars['String'];
}>;

export type UpdateDisplayNameMutation = { updateDisplayName: { id: string; displayName: string } };
                            ...
                            selections: [
                                { kind: 'Field', name: { kind: 'Name', value: 'token' } },
                                {
                                    ...
                                    selectionSet: {
                                        kind: 'SelectionSet',
                                        selections: [
                                            { kind: 'FragmentSpread', name: { kind: 'Name', value: 'UserFullData' } },
                                        ],
                                    },
                                },
                            ],
